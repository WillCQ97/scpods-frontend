        ...
        <v-card>
          ...
          <v-card-text>
            <p>
              ...
              sociedade, empresas, academias e pessoas, no qual foram definidos
              17 objetivos e 169 metas para o fomento de um desenvolvimento mais
        ...
        <v-card>
          ...
          <v-card-text>
            <p>
              ...
              princípios dos ODS nas suas diferentes frentes de atuação (ensino,
              pesquisa, extensão, assistência e gestão), fortalecendo vínculos e
              criando conexão entre essas áreas.
            </p>
            <p>
              Em 2020, teve início o projeto institucional de integração dos ODS
